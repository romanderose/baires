...
export function Footer() {
  ...
  return (
    <footer 
      className="w-full" 
      style={{ backgroundColor: theme === 'dark' ? 'rgb(7, 21, 77)' : 'rgb(40, 80, 160)' }}
    >
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
          ...
          <div>
            ...
            <div className="space-y-2">
              {/* Email - Sin enlace externo, color naranja */}
              <div 
                className="flex items-center gap-2 text-base transition-colors duration-300"
                style={{ color: theme === 'dark' ? 'rgb(209, 213, 219)' : 'white' }}
                onMouseEnter={(e) => {
              ...
              >
                ...
                <span>bairessuspension@gmail.com</span>
              </div>

              {/* Teléfono - Sin enlace externo, color naranja */}
              <div 
                className="flex items-center gap-2 text-base transition-colors duration-300"
                style={{ color: theme === 'dark' ? 'rgb(209, 213, 219)' : 'white' }}
                onMouseEnter={(e) => {
              ...
              {/* WhatsApp - Link externo, color verde brillante */}
              <a
              ...
              >
                ...
                <span>+541124058024</span>
              </a>

              {/* Facebook - Link externo, color azul brillante */}
              <a
              ...
              >
                ...
                <span>/bairessuspension</span>
              </a>

              {/* Instagram - Link externo, gradiente rojo-naranja */}
              <a
          ...
          <div>
            ...
            {/* Dirección - Sin enlace externo, color naranja */}
            <div
              className="flex items-center gap-2 text-base mb-3 transition-colors duration-300"
              style={{ color: theme === 'dark' ? 'rgb(209, 213, 219)' : 'white' }}
              onMouseEnter={(e) => {
                e.currentTarget.style.color = 'rgb(255, 140, 0)';
              }}
            ...
            >
              ...
              <span>Av. Hipólito Irigoyen 1099, Morón</span>
            </div>
        ...
        <div className="text-center pt-4 border-t border-white/20">
          ...
          >
            Desarrollado por Román De Rose ©
          </p>
        </div>
      </div>
    </footer>
