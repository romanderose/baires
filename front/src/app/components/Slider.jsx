...
import bairesSuspensionImg from "figma/5bf6c10c6d44ed2eaf54f59590268558098c0f87.png";
import arrowIcon from "figma/18d4bb9bdaefa75f46d6589fef8388d2235a378c.png";
...
export function Slider() {
  ...
  const slides = [
    ...
    { type: "text", content: "Imagen 2" },
    { type: "text", content: "Imagen 3" },
    { type: "text", content: "Imagen 4" },
  ];
  ...
  return (
    <div className="p-[30px]" style={{ marginTop: '48px' }}>
      ...
      >
        ...
        <button
          onClick={prevSlide}
          className="absolute left-1 top-1/2 -translate-y-1/2 transition-all duration-200 hover-110 active-95"
        ...
        <button
          onClick={nextSlide}
          className="absolute right-1 top-1/2 -translate-y-1/2 transition-all duration-200 hover-110 active-95"
          style={{ width: "50px", height: "50px" }}
        >
          <img
            src={arrowIcon}
