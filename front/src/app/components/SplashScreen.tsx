...
export function SplashScreen() {
  return (
    <div className="fixed inset-0 flex items-center justify-center border-[15px] border-red-600" style={{ backgroundColor: 'rgb(11, 32, 110)', boxShadow: 'inset 0 0 0 15px rgb(0, 161, 255)' }}>
      <div className="flex flex-col items-center">
        <img 
          src={logoImage} 
          alt="Baires Suspensión" 
          className="w-auto h-48 sm:h-56 md:h-64 object-contain"
        />
